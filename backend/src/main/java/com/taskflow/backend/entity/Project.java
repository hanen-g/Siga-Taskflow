...
public class Project {
    ...
    /**
     * Optional on admin POST /api/projects: ids of existing users with role CLIENT to invite as project members.
     * Not stored as a column; used only when building {@link #members}, then cleared.
     */
    @Transient
